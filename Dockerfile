...
# Update packages
RUN apt-get update && apt-get install -y php5 php5-mcrypt php5-mysql php5-gd php5-curl php5-memcached php5-cli php5-readline php5-mysqlnd php5-json php5-intl libapache2-mod-php5 memcached
